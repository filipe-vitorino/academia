...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      ...
      name: 'Exercicio',
      lastPropertyId: const obx_int.IdUid(5, 5251216810958037320),
      flags: 0,
  ...
  obx_int.ModelEntity(
      ...
      name: 'Ficha',
      lastPropertyId: const obx_int.IdUid(2, 5372589789326879686),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      relations: <obx_int.ModelRelation>[
        obx_int.ModelRelation(
            id: const obx_int.IdUid(2, 2077406152030735232),
            name: 'fichas',
            targetId: const obx_int.IdUid(2, 6192234135157461721))
      ],
      backlinks: <obx_int.ModelBacklink>[])
];
...
obx_int.ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Exercicio: obx_int.EntityDefinition<Exercicio>(
        model: _entities[0],
        toOneRelations: (Exercicio object) => [],
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final musculoAlvoParam =
              const fb.StringReader(asciiOptimization: true)
                  .vTableGet(buffer, rootOffset, 8, '');
          final seriesParam =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 10, 0);
          final repeticoesParam =
    ...
    Ficha: obx_int.EntityDefinition<Ficha>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Ficha(titulo: tituloParam)
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          obx_int.InternalToManyAccess.setRelInfo<Ficha>(object.exercicios,
              store, obx_int.RelInfo<Ficha>.toMany(1, object.id));
          return object;
        }),
    Usuario: obx_int.EntityDefinition<Usuario>(
        ...
        toManyRelations: (Usuario object) =>
            {obx_int.RelInfo<Usuario>.toMany(2, object.id): object.fichas},
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Usuario(
              nome: nomeParam, email: emailParam, password: passwordParam)
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          obx_int.InternalToManyAccess.setRelInfo<Usuario>(object.fichas, store,
              obx_int.RelInfo<Usuario>.toMany(2, object.id));
          return object;
        })
  };
...
class Exercicio_ {
  /// See [Exercicio.id].
  static final id =
      obx.QueryIntegerProperty<Exercicio>(_entities[0].properties[0]);

  /// See [Exercicio.nome].
  static final nome =
      obx.QueryStringProperty<Exercicio>(_entities[0].properties[1]);

  /// See [Exercicio.musculoAlvo].
  static final musculoAlvo =
      obx.QueryStringProperty<Exercicio>(_entities[0].properties[2]);

  /// See [Exercicio.series].
  static final series =
      obx.QueryIntegerProperty<Exercicio>(_entities[0].properties[3]);

  /// See [Exercicio.repeticoes].
  static final repeticoes =
      obx.QueryIntegerProperty<Exercicio>(_entities[0].properties[4]);
}
...
class Ficha_ {
  ...
  /// See [Ficha.titulo].
  static final titulo =
      obx.QueryStringProperty<Ficha>(_entities[1].properties[1]);

  /// see [Ficha.exercicios]
  static final exercicios =
      obx.QueryRelationToMany<Ficha, Exercicio>(_entities[1].relations[0]);
}
...
class Usuario_ {
  /// See [Usuario.id].
  static final id =
      obx.QueryIntegerProperty<Usuario>(_entities[2].properties[0]);

  /// See [Usuario.nome].
  static final nome =
      obx.QueryStringProperty<Usuario>(_entities[2].properties[1]);

  /// See [Usuario.email].
  static final email =
      obx.QueryStringProperty<Usuario>(_entities[2].properties[2]);

  /// See [Usuario.password].
  static final password =
      obx.QueryStringProperty<Usuario>(_entities[2].properties[3]);

  /// see [Usuario.fichas]
  static final fichas =
      obx.QueryRelationToMany<Usuario, Ficha>(_entities[2].relations[0]);
}
